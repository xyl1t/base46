...
M.base_30 = {
  white         = palette.text,
  darker_black  = palette.curst,
  black         = palette.mantle, --  nvim bg
  black2        = palette.base,
  one_bg        = palette.surface0,
  one_bg2       = palette.surface1,
  one_bg3       = palette.surface2,
  grey          = palette.overlay0,
  grey_fg       = palette.overlay1,
  grey_fg2      = palette.overlay2,
  light_grey    = palette.subtext0,
  red           = palette.red,
  baby_pink     = palette.maroon,
  pink          = palette.pink,
  line          = palette.surface0, -- for lines like vertsplit
  green         = palette.green,
